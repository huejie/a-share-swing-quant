...
const base={entry:'¥42.80—43.60',entryState:'趋势回踩',initialWeight:10,score:75,initialStop:40.9,expectedHoldingDays:[40,80] as [number,number],nextReviewAt:'2026-07-13 18:00',version:'MVP-0.9.3',timestamp:'2026-07-06 16:12',kind:'model' as const};
export const demoSnapshot:Snapshot={
 ...
 market:{state:'震荡偏强',score:68,exposure:72,style:'中盘成长 · 制造优先',summary:'广度继续修复，但成交未同步放大。维持七成仓位，不追逐加速题材。',factors:[
  {name:'A股趋势与广度',score:76,weight:25,note:'全A 61%站上60日线，连续3日改善'},
  {name:'风格结构',score:71,weight:20,note:'中证1000相对沪深300转强'},
  {name:'成交与流动性',score:57,weight:15,note:'成交额低于20日均值4.2%'},
  {name:'全球风险',score:63,weight:15,note:'美元回落，离岸人民币波动收敛'},
  {name:'情绪与拥挤',score:66,weight:15,note:'涨停扩散，连板高度仍克制'},
  {name:'估值与风险溢价',score:55,weight:10,note:'估值处历史中性区间'}]},
 holdings:[
 ...
 themes:[
  {name:'机器人执行器',phase:'扩散',score:82,breadth:76,flow:74,crowding:61,relativeStrength:85,fundamental:70,catalyst:72,leadership:80,note:'从龙头向核心零部件扩散'},
  {name:'半导体设备',phase:'启动',score:78,breadth:68,flow:71,crowding:48,relativeStrength:81,fundamental:74,catalyst:76,leadership:79,note:'订单与价格信号同步改善'},
  {name:'出海消费',phase:'健康趋势',score:73,breadth:64,flow:58,crowding:39,relativeStrength:70,fundamental:77,catalyst:60,leadership:73,note:'低拥挤的组合平衡项'},
  {name:'光模块',phase:'加速',score:72,breadth:55,flow:84,crowding:78,relativeStrength:88,fundamental:72,catalyst:66,leadership:82,note:'趋势强，但停止新增仓位'},
  {name:'创新药',phase:'潜伏',score:64,breadth:52,flow:46,crowding:31,relativeStrength:58,fundamental:62,catalyst:71,leadership:55,note:'催化增加，尚未价格确认'},
  {name:'低空经济',phase:'退潮',score:42,breadth:31,flow:27,crowding:69,relativeStrength:35,fundamental:50,catalyst:42,leadership:37,note:'龙头与中位数同步走弱'}],
 decisions:[
 ...
 simulation:{matchingReady:true,matchingReason:'演示撮合仅用于验证流程',cash:280000,marketValue:720000,equity:1000000,drawdown:-0.021,positions:[],ledger:[],dailyEquity:[{day:'2026-07-06',cash:280000,marketValue:720000,equity:1000000,drawdown:-0.021}]}
};
